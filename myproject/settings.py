...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Whitenoise giúp quản lý file tĩnh
...
# Chỉ định thư mục static root nơi Render sẽ thu thập tất cả các file tĩnh
...
# Chỉ định công cụ quản lý file tĩnh
